...
\name{print.survfitDistributed}
\alias{print.survfitDistributed}
\alias{survfitDistributed.stats}
\alias{survfitDistributed.formula}
\alias{survfitDistributed}
\alias{survfitDistributed.object}
\title{Create Survival Curves for Vertical Distributed Cox Regression}
\usage{
...
\item{data}{if \code{formula} is specified, this should be the data that was
